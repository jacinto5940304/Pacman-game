...
static void init() {
    ...
    //    Uncomment and fill the code below
    //btnSettings = button_create(730, 20, 50, 50, "Assets/setting1.png", "Assets/setting2.png");
    btnSettings = button_create(700, 50, 70, 70, "Assets/setting1.png", "Assets/setting2.png");
